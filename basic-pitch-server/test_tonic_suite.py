...
# v2.25.0 P1 三支柱专项:三和弦骨架锁定根音(3音);导音解决;V→I 五度下行
cases.append(("三和弦骨架·3音 C-E-G", 0, "major", mk_notes([60, 64, 67], [0.5, 0.4, 0.7])))
cases.append(("三和弦骨架·3音 B-D-F#", 11, "minor", mk_notes([59, 62, 66], [0.5, 0.4, 0.7])))
cases.append(("导音解决·短导音+长主音", 0, "major", mk_notes([64, 65, 67, 71, 72], [0.5, 0.3, 0.4, 0.25, 0.9])))
cases.append(("V→I 五度下行·G-C", 0, "major", mk_notes([60, 64, 67, 55, 48], [0.5, 0.4, 0.5, 0.3, 1.0])))
# 长旋律（22 音）
